...
#Init CANape
canape.Open1(r"D:\liyi10\testScript",1,50000,True)
print('CANape initialized.')

#Init XCP Device
dev = canape.Devices.Add("XCPsim_1",r"D:\liyi10\testScript\VMM_main_Updated.a2l","XCP",1)
print('Device \'XCPsim_1\' added.')

#Adding the ampl object
dev.CalibrationObjects.Add("P_VMMSG_ADSAELevel")
calob = dev.CalibrationObjects.Item("P_VMMSG_ADSAELevel")
